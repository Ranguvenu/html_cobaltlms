...
//     $user_costcenter = $DB->get_record('user', array('id' => $USER->id));
...
//     if (($user_costcenter->open_departmentid != $course_costcenter->open_departmentid)) {
//         if($course->open_identifiedas==6){
//             redirect($CFG->wwwroot.'/local/opencourses/opencourses.php');
//             die;
//         } else{
...
//     if (($user_costcenter->open_subdepartment != $course_costcenter->open_subdepartment)) {
//         if($course->open_identifiedas==6){
//             redirect($CFG->wwwroot.'/local/opencourses/opencourses.php');
//             die;
//         } else{
...
//     }
// } /*else {
//      $contexcourse = \context_course::instance($course_costcenter->id);
...
//         $PAGE->navbar->add(get_string('pluginname', 'local_courses'), new moodle_url('/local/opencourses/opencourses.php'));
// }else{
//         $PAGE->navbar->add(get_string('dashboard', 'local_program'), new moodle_url('/index.php'));
// }
//          $PAGE->navbar->add($course->fullname);
//         // index.php
//     }
    // $PAGE->navbar->ignore_active(true);
    /* DM-250 - Dipanshu kasera - bread crumbs required - ends */
    echo $OUTPUT->header();
