...
class cm implements renderable {
    ...
    public function export_for_template(\renderer_base $output): stdClass {
        ...
        /* Dipanshu Kasera code starts:: To hide the Attendance activity from left navigation */

        if ($data->name == 'attendance') {
            unset($data->url);
            unset($data->name);
        }

        /* Dipanshu Kasera code ends:: To hide the Attendance activity from left navigation */
