...
$string['alreadyexisted'] = 'Session already exists !!!';
$string['alreadyotherexisted'] = 'Session already exists in the given timings for this teacher in other course!!!';
$string['Aacronym'] = 'A';
$string['Afull'] = 'Absent';
$string['Eacronym'] = 'E';
...
$string['deletecheckfull'] = 'Do you really want to delete this acronym?';
...
$string['semesterstartson'] = 'Semester starts on "{$a}"';
$string['semesterendson'] = 'Semester ends on "{$a}"';
...
$string['studentscanmark'] = 'Allow students to record attendance';
$string['studentscanmark_desc'] = 'If checked, teachers will be able to allow students to mark their attendance.';
$string['studentscanmark_help'] = 'If checked students will be able to change their attendance status for the session.';
...
$string['instructor'] = 'Instructor / Faculty';
$string['noteacherassign'] = 'No Instructor / Faculty is<br>assigned to this course';
$string['overallratings'] = 'Overall ratings';
$string['Cancel'] = 'Cancel';
$string['employee'] = 'Teacher';
$string['select_teacher'] = 'Please select teacher';
$string['selectrole'] = 'Select teacher';
$string['sessionname'] = 'Session name';
$string['errorsessionname'] = 'Session name should not be empty';
