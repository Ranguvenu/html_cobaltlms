...
class mobile {
    ...
    public static function mobile_view_activity($args) {
        ...
        return [
            ...
            'javascript' => 'const that = this;
function AddonModAttendanceLinkHandler() {
    that.CoreContentLinksModuleIndexHandler.call(this, that.CoreCourseHelperProvider, "AddonModAttendance", "attendance");

    this.name = "AddonModAttendanceLinkHandler";
}

AddonModAttendanceLinkHandler.prototype = Object.create(this.CoreContentLinksModuleIndexHandler.prototype);
AddonModAttendanceLinkHandler.prototype.constructor = AddonModAttendanceLinkHandler;


this.CoreContentLinksDelegate.registerHandler(new AddonModAttendanceLinkHandler());',
            'otherdata' => ''
        ];
    }
