...
$classes = $DB->get_records_sql("SELECT * FROM {submissions} WHERE status = 1");
...
$table->head[] = get_string('DateOfApprovals','block_hod');
...
$classes = $DB->get_records_sql("SELECT * FROM {submissions} WHERE status = 1 and approveronestatus = 1");
$table = new html_table();
$table->id = "custom_table_class";
$table->head[] = get_string('SNo','block_hod');
$table->head[] = get_string('PIName','block_hod');
...
$classes = $DB->get_records_sql("SELECT * FROM {submissions} WHERE status = 1 and approveronestatus = 1 and approvertwostatus = 1");
$table = new html_table();
$table->id = "custom_table_class";
$table->head[] = get_string('SNo','block_hod');
$table->head[] = get_string('PIName','block_hod');
