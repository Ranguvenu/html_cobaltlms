...
$classes = $DB->get_records_sql("SELECT * FROM {submissions} WHERE status = 2");
...
$table->head[] = get_string('DateOfRejected','block_hod');
$table->head[] = get_string('ApplicationType','block_hod');
$table->head[] = get_string('ProjectCode','block_hod');
$table->head[] = get_string('Comment','block_hod');
...
$classes = $DB->get_records_sql("SELECT * FROM {submissions} WHERE status = 2 or status = 1 and approveronestatus = 2");
...
$classes = $DB->get_records_sql("SELECT * FROM {submissions} WHERE (status = 2 or status =1) and (approveronestatus = 1 or approveronestatus = 2) and approvertwostatus = 2");
