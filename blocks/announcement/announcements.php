...
$heading = get_string('siteannouncement', 'block_announcement');
	...
	echo "<ul class='course_extended_menu_list'>
			  <li>
					<div class='coursebackup'>   
						 <a class='course_extended_menu_itemlink btn btn-sm create_btn mb-4' title='Create Announcement' data-action='announcementmodal' onclick ='(function(e){ require(\"block_announcement/announcement\").init({selector:\"announcementmodal\", contextid:$systemcontext->id, id:0}) })(event)'>
						 	".get_string('create_announcement','block_announcement')."
						 </a>
					</div>
			  </li>
		 </ul>";
		...
		echo "<ul class='course_extended_menu_list'>
			  <li>
					<div class='coursebackup course_extended_menu_itemcontainer'>   
						 <a class='course_extended_menu_itemlink' title='Create Announcement' data-action='announcementmodal' onclick ='(function(e){ require(\"block_announcement/announcement\").init({selector:\"announcementmodal\", contextid:$systemcontext->id, id:0}) })(event)'><i class='icon fa fa-plus' aria-hidden='true'></i>
							  </a>
					</div>
			  </li>
		 </ul>";
