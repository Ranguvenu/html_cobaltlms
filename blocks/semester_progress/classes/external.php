...
class block_semester_progress_external extends external_api {
    ...
    public static function semester_view($options, $dataoptions, $offset = 0, $limit = 0, $contextid, $filterdata)
    {
        ...
        require_login();
        $PAGE->set_url('/blocks/semester_progress/semesterprogress_table.php', array());
        ...
        $data = get_listof_current_semester_courses($stable, $filtervalues);
