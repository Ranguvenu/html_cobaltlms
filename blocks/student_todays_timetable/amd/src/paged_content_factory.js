...
[
    ...
    'core/templates',
    'core/notification',
    'block_student_todays_timetable/paged_content',
    'block_student_todays_timetable/paged_content_pages',
    'core/pubsub',
    'core/ajax'
],
function(
    ...
    var TEMPLATES = {
        PAGED_CONTENT: 'block_student_todays_timetable/paged_content'
    };
