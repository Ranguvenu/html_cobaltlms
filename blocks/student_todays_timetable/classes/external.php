...
class block_student_todays_timetable_external extends external_api {

     /**
     * Describes the parameters for submit_create_course_form webservice.
     * @return external_function_parameters
     */
    public static function subject_view_parameters() {
     ...
     /**
       ...
       */
    public static function subject_view($options, $dataoptions, $offset = 0, $limit = 0, $contextid, $filterdata) {

        global $DB, $CFG, $USER, $PAGE;
        require_login();
        $PAGE->set_url('/blocks/student_todays_timetable/studenttime_table.php', array());
        $PAGE->set_context($contextid);
        require_once($CFG->dirroot . '/blocks/student_todays_timetable/lib.php');

        $params = self::validate_parameters(
            self::subject_view_parameters(),
            [
                'options' => $options,
        ...
        $data = get_listof_courses_and_faculty($stable, $filtervalues);
     ...
     * @since Moodle 3.0
     */
    public static function subject_view_returns() {
                    ...
                    'hascourses' => new external_multiple_structure(
                        new external_single_structure(
                            array(
                                ...
                                'faculty_name' => new external_value(PARAM_RAW, 'faculty_name', VALUE_OPTIONAL),
