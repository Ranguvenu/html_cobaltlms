...
define(['block_teachers_tests_summary/jquery.dataTables', 'jquery', 'core/str', 'core/modal_factory', 'core/modal_events',
    ...
    NewPopup.prototype.init = function() {
        ...
        $(document).on('click', '.inprogressquizpopup', function(){
    ...
    NewPopup.prototype.dataTableshow = function(){
        Str.get_strings([
            ...
            $('#inprogressquiz_student_summary').DataTable({
                'bPaginate': true,
                'bFilter': true,
                'bLengthChange': true,
                'lengthMenu': [
    ...
    NewPopup.prototype.getBody = function(formdata) {
        ...
        return Fragment.loadFragment('block_teachers_tests_summary', 'students_inprogressquiz_display', this.contextid, params);
    };
