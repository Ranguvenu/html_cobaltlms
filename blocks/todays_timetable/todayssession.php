...
$PAGE->set_url('/blocks/todays_timetable/todayssession.php');

$PAGE->set_title(get_string('head_todays_sessions', 'block_todays_timetable'));
$PAGE->requires->jquery();
$PAGE->navbar->add(get_string('todays_sessions', 'block_todays_timetable'));
$heading = get_string('head_todays_sessions', 'block_todays_timetable');
...
echo $OUTPUT->header();
        ...
        $filterparams = $renderer->todays_courses_content(true);
        $mform = new filters_form(null, array('filterlist' => array('todays_course'), 'filterparams' => $filterparams));
            if ($mform->is_cancelled()) {
                redirect($CFG->wwwroot . '/blocks/todays_timetable/todayssession.php');
            }
    ...
    echo $renderer->todays_courses_content();
    echo $OUTPUT->footer();
