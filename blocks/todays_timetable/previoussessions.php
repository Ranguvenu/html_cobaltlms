...
$PAGE->set_url('/blocks/todays_timetable/previoussessions.php');
// Header and the navigation bar.
$PAGE->set_title(get_string('head_previous_sessions', 'block_todays_timetable'));
$PAGE->requires->jquery();
$PAGE->navbar->add(get_string('previous_sessions', 'block_todays_timetable'));
$heading = get_string('head_previous_sessions', 'block_todays_timetable');
...
echo $OUTPUT->header();
        ...
        $filterparams = $renderer->previous_courses_content(true);
        $mform = new filters_form(null, array('filterlist' => array('previous_course'), 'filterparams' => $filterparams));
            if ($mform->is_cancelled()) {
                redirect($CFG->wwwroot . '/blocks/todays_timetable/previoussessions.php');
            }
    ...
    echo $renderer->previous_courses_content();
    echo $OUTPUT->footer();
