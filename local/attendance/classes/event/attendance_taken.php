...
class attendance_taken extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventtaken', 'local_attendance');
    }
    ...
    public function get_url() {
        return new \moodle_url('/local/attendance/take.php', array('id' => $this->contextinstanceid,
    ...
    protected function validate_data() {
        if (empty($this->other['sessionid'])) {
            throw new \coding_exception('The event local_attendance\\event\\attendance_taken must specify sessionid.');
        }
