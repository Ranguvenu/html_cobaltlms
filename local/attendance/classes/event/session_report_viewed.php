...
class session_report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventstudentattendancesessionsviewed', 'local_attendance');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/local/attendance/view.php', array('id' => $this->contextinstanceid,
