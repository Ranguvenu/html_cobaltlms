...
class session_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsessionupdated', 'local_attendance');
    }
    ...
    public function get_url() {
        return new \moodle_url('/local/attendance/sessions.php', array('id' => $this->contextinstanceid,
    ...
    protected function validate_data() {
        if (empty($this->other['info'])) {
            throw new \coding_exception('The event local_attendance\\event\\session_updated must specify info.');
        }
        if (empty($this->other['sessionid'])) {
            throw new \coding_exception('The event local_attendance\\event\\session_updated must specify sessionid.');
        }
        if (empty($this->other['action'])) {
            throw new \coding_exception('The event local_attendance\\event\\session_updated must specify action.');
        }
