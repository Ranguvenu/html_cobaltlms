...
class session_duration_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdurationupdated', 'local_attendance');
    }
    ...
    public function get_url() {
        return new \moodle_url('/local/attendance/manage.php', array('id' => $this->contextinstanceid));
    }
    ...
    protected function validate_data() {
        if (empty($this->other['info'])) {
            throw new \coding_exception('The event local_attendance\\event\\session_duration_updated must specify info.');
        }
