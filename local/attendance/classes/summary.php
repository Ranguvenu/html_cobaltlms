 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class local_attendance_summary {
    ...
    public function get_user_taken_sessions_percentages() {
        ...
        foreach ($this->userspoints as $userid => $userpoints) {
            $percentages[$userid] = local_attendance_calc_fraction($userpoints->points, $userpoints->maxpoints);
        }
    ...
    public function get_taken_sessions_summary_for($userid) {
        ...
        $usersummary->takensessionspercentage = local_attendance_calc_fraction($usersummary->takensessionspoints,
    ...
    public function get_all_sessions_summary_for($userid) {
        ...
        $usersummary->allsessionspercentage = local_attendance_calc_fraction($usersummary->takensessionspoints,
        ...
        $usersummary->maxpossiblepercentage = local_attendance_calc_fraction(($usersummary->takensessionspoints + $deltapoints),
                                                                       $usersummary->allsessionsmaxpoints);
