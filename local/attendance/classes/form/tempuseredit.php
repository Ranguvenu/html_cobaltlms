...
class tempuseredit extends \moodleform {
    ...
    public function definition() {
        ...
        $buttonarray = array(
            $mform->createElement('submit', 'submitbutton', get_string('edituser', 'local_attendance')),
    ...
    public function validation($data, $files) {
        ...
        if ($err = \local_attendance_structure::check_existing_email($data['temail'], $data['userid'])) {
            $errors['temail'] = $err;
        }
        return $errors;
    }
