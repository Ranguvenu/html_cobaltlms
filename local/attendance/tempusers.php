...
$att = new local_attendance_structure($att, $cm, $course);
...
$tabs = new local_attendance\output\tabs($att, local_attendance\output\tabs::TAB_TEMPORARYUSERS);

$formdata = (object)array(
    'id' => $cm->id,
);
$mform = new local_attendance\form\tempuser();
 ...
 */
function attendance_print_tempusers($tempusers, local_attendance_structure $att) {
    echo '<p></p>';
