...
$pageparams = new local_attendance_report_page_params();
...
$att = new local_attendance_structure($attrecord, $cm, $course, $context, $pageparams);
...
$tabs = new local_attendance\output\tabs($att, local_attendance\output\tabs::TAB_REPORT);
$filtercontrols = new local_attendance\output\filter_controls($att, true);
$reportdata = new local_attendance\output\report_data($att);

// Trigger a report viewed event.
$event = \local_attendance\event\report_viewed::create(array(
    'objectid' => $att->id,
