 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class local_attendance_user_sessions_cells_generator {
    ...
    /**
     * Set up params.
     * @param local_attendance\output\report_data $reportdata - reportdata.
     * @param stdClass $user - user record.
     */
    public function  __construct(local_attendance\output\report_data $reportdata, $user) {
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class local_attendance_user_sessions_cells_html_generator extends local_attendance_user_sessions_cells_generator {
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class local_user_sessions_cells_text_generator extends local_attendance_user_sessions_cells_generator {
 ...
 * @return string.
 */
function local_attendance_construct_user_data_stat($usersummary, $view) {
 ...
 *
 */
function local_construct_full_user_stat_html_table($attendance, $user) {
    $summary = new local_attendance_summary($attendance->id, $user->id);
    return local_attendance_local_attendance_construct_user_data_stat($summary->get_all_sessions_summary_for($user->id), ATT_VIEW_ALL);
}
