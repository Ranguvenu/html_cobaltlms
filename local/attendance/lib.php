 ...
 */
function local_attendance_add_default_warnings($id) {
    global $DB, $CFG;
...
function local_attendance_add_instance($attendance) {
    ...
    local_attendance_add_default_warnings($attendance->id);
 ...
 */
function local_attendance_print_settings_tabs($selected = 'settings') {
    global $CFG;
    ...
    $tabs[] = new tabobject('defaultstatus', $CFG->wwwroot.'/local/attendance/defaultstatus.php',
        get_string('defaultstatus', 'attendance'), get_string('defaultstatus', 'attendance'), false);

    if (get_config('attendance', 'enablewarnings')) {
        $tabs[] = new tabobject('defaultwarnings', $CFG->wwwroot . '/local/attendance/warnings.php',
            get_string('defaultwarnings', 'attendance'), get_string('defaultwarnings', 'attendance'), false);
    }

    $tabs[] = new tabobject('coursesummary', $CFG->wwwroot.'/local/attendance/coursesummary.php',
        get_string('coursesummary', 'attendance'), get_string('coursesummary', 'attendance'), false);

    if (get_config('attendance', 'enablewarnings')) {
        $tabs[] = new tabobject('absentee', $CFG->wwwroot . '/local/attendance/absentee.php',
            get_string('absenteereport', 'attendance'), get_string('absenteereport', 'attendance'), false);
    }

    $tabs[] = new tabobject('resetcalendar', $CFG->wwwroot.'/local/attendance/resetcalendar.php',
        get_string('resetcalendar', 'attendance'), get_string('resetcalendar', 'attendance'), false);

    $tabs[] = new tabobject('importsessions', $CFG->wwwroot . '/local/attendance/import/sessions.php',
 ...
 */
function local_attendance_remove_user_from_thirdpartyemails($warnings, $userid) {
    global $DB;
