...
if (($action == 'courseenroll')) {
    ...
    switch($type) {
        case 'idnumber':
            $idnumbers = $costcenterlib->get_enrolledcoursefilter_users_employeeids($costcenter, 
                         $like, $page, $course_id, $filterpage);
        ...
        break;
        case 'department':
            $departments = $costcenterlib->get_enrolledcoursefilter_users_departments($costcenter, 
                           $like, $page, $course_id, $filterpage);
            echo json_encode($departments);
        break;
        case 'subdepartment':
            $subdepartments = $costcenterlib->get_enrolledcoursefilter_users_subdepartments($costcenter, $like, $page, 
                              $course_id, $filterpage, $departments);
