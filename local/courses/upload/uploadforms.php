...
class local_uploadcourse_step1_form extends tool_uploadcourse_base_form {
    ...
    public function definition () {
        ...
        $mform->addElement('filepicker', 'coursefile', get_string('coursefile', 'local_courses'), null, $filepickeroptions);
        $mform->addRule('coursefile', get_string('errorcsv', 'local_courses'), 'required');
...
class local_uploadcourse_step2_form extends tool_uploadcourse_base_form {
    ...
    public function definition () {
        ...
        if (is_siteadmin($USER)) {
            ...
            $options[null] = get_string('selectcostcenter', 'local_courses', $labelstring);
            $data = $options + $displaylist;
            $mform->addElement('select', 'defaults[open_costcenterid]', get_string('open_costcenterid', 'local_courses', $labelstring), $data);
