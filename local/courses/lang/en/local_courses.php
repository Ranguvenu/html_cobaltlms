...
$string['activeconfirm'] = 'Do you really want to activate this category?';
$string['activity'] = 'Activity';
$string['addcategory'] = '<i class="fa fa-book secbook popupstringicon cat_pop_icon mr-2" aria-hidden="true"></i> Create New Category <div class= "popupstring"></div>';
...
$string['cannotcreateorupdatecourse'] = 'Cannot create or update course';
$string['invalidcoursetype'] = 'Invalid course type ';
$string['invalidcoursecategory'] = 'Invalid course category ';
$string['invalidcategorycode'] = 'Category code isn\'t exists in selected organization ';
$string['cannotuploadcoursewithlob'] = 'With out Department cannot upload a course with Sub Department';
$string['canonlycreatecourseincategoryofsameorganisation'] = 'You can only create the course under your assigned college';
...
$string['cardtypeicon'] ='icon fa fa-th fa-fw';
$string['catalog'] = 'Catalog';
$string['categories'] = 'Subcategory :  ';
...
$string['categorymissing'] = 'Missing header: category_code, give header name "category_code" on colomn "C" in the uploaded CSV file';
...
$string['coursecodemissing'] = 'Missing header: course-code, give header name "course-code" on colomn "B" in the uploaded CSV file';
...
$string['courseexists'] = 'Course name Already Existed ';
...
$string['coursetypemissing'] = 'Missing header: coursetype, give header name "coursetype" on colomn "D" in the uploaded CSV file';
...
$string['deleteconfirm'] = 'Do you really want to delete <b>{$a->name}</b>, which you can\'t revert if removed?';
$string['deleteuser'] = 'Delete confirmation';
$string['department'] = 'Department';
$string['departments']='Departments';
$string['deptnotexists']='{$a} does not exist';
$string['deptorsubdeptexists']='{$a} does not exist';
...
$string['disablecourse'] = 'Do you really want to inactivate <b>{$a}</b>?';
$string['download_certificate'] = 'Download Certificate';
$string['doyouwantto_addthecontent'] = 'Do you want to <b>add the content</b>?';
$string['doyouwantto_enrolusers'] = 'Do you want to <b>enroll users</b>?';
$string['edit'] = 'Edit';
$string['editcategory'] = '<i class="fa fa-book secbook popupstringicon cat_pop_icon mr-2" aria-hidden="true"></i> Update Category <div class= "popupstring"></div>';
...
$string['elearning'] = 'Template';
$string['email']='Email';
$string['employeename'] = 'Employee Name';
$string['employeesearch']='Filter';
$string['empnumber']='Employee ID';
$string['emptycsverror'] = 'Missing value for mandatory fields: fullname, category, coursetype, format, course-code';
$string['enablecourse'] = 'Do you really want to activate <b>{$a}</b>?';
...
$string['entercategory'] = 'Please enter category name';
$string['entercategorycode'] = 'Please enter category code';
$string['err_category'] = 'Please select a category';
$string['err_certificate'] = 'Missing Certificate template';
$string['err_points'] = 'Points cannot be empty';
$string['errorcsv'] = 'Upload a valid CSV file';
$string['errorcsvfile'] = 'Please upload a valid CSV file';
...
$string['formatmissing'] = 'Missing header: format, give header name "format" on colomn " I " in the uploaded CSV file';
$string['fullnamecourse'] = 'Fullname';
$string['fullnamemissing'] = 'Missing header: fullname, give header name "fullname" on colomn "A" in the uploaded CSV file';
$string['goto'] = 'Go to';
...
<tr><td>coursetype</td><td>Type of the course [elearning(i.e Template)].</td></tr>
<tr><td>format</td><td>Enter course format(Ex: singleactivity,social,topics,weeks).</td></tr>';
$string['help_2'] = '</td></tr>
<tr><td></td><td style="text-align:left;border-left:1px solid white;padding-left:50px;"><b>Non-Mandatory Fields</b></td><tr>
<th>Field</th><th>Restriction</th>
<tr><td>Summary</td><td>Summary of the course.</td></tr>
<tr><td>{$a->secondlevel}</td><td>Shortname of the {$a->secondlevel}.</td></tr>
<tr><td>{$a->thirdlevel}</td><td>Shortname of the {$a->thirdlevel}.</td></tr>
</table>';
...
$string['inactiveconfirm'] = 'Do you really want to inactivate this category?';
...
$string['leftmenu_manage_courses'] = 'Manage Courses';
$string['leftmenu_manage_evidence'] = 'Requests';
$string['leftmenu_noticeboard'] = 'Announcements';
$string['leftmenu_certificate'] = 'Certificates';
$string['leftmenu_queries'] = 'Ask a Question';
$string['leftmenu_timetale'] = 'Timetable';
$string['listtype'] ='LIST';
$string['listtypeicon'] ='icon fa fa-bars';
...
$string['missingfullname'] = 'Please enter a valid  Name';
$string['missingshortname'] = 'Please enter a valid  Code';
$string['missingtype'] = 'Missing Type';
$string['missingtype'] = 'Please Select Type';
$string['mooc'] = 'MOOC';
$string['my_evidences'] = 'My Requests';
$string['my_examcompletions'] = 'My Exams';
$string['my_online_courses'] = 'My Courses';
...
$string['notyourorgcourse_msg'] = 'You have tried to view this course is not belongs to your {$a->firstlevel}';
$string['notyourdeptcourse_msg'] = 'You have tried to view this course is not belongs to your {$a->secondlevel}';
$string['notyoursubdeptcourse_msg'] = 'You have tried to view this course is not belongs to your {$a->thirdlevel}';
$string['notyourorg_msg'] = 'You have tried to view this activity is not belongs to your College';
$string['notyourorgcoursereport_msg'] = 'You have tried to view this Grader report is not your College course, so you cann\'t access this page';
$string['nousersmsg'] = 'No users Available';
$string['open_costcenterid'] = '{$a->firstlevel}';
$string['open_costcenteridcourse'] = 'Organization';
$string['open_costcenteridcourse_help'] = 'Organization for the course';
...
$string['reason_coursesexists'] = 'You cannot delete this course category as it has course';
$string['reason_linkedtocostcenter'] = 'You cannot delete this category as it has been linked with the college/department';
$string['reason_subcategoriesexists'] = 'You cannot delete this category as it has subcategories';
...
$string['selectdept'] = '--Select {$a->secondlevel}--';
...
$string['selectsubdept'] = '--Select {$a->thirdlevel}--';
...
$string['spacesnotallowed'] = 'Spaces are not allowed';
$string['status'] = 'Status';
$string['subdeptnotexists'] = '{$a} does not exist';
...
$string['cannotemptycoursetype'] = 'Coursetype cannot be empty';
$string['missingcourseformat'] = 'Course format cannot be empty';
$string['cannotdelete'] = 'You cannot delete the <b>{$a}</b> course as it is being used in an active curriculum';
$string['cannothide'] = 'You cannot inactive the <b>{$a}</b> course as it is being used in an active curriculum';
$string['selectcostcenter'] = 'Select {$a->firstlevel}';
