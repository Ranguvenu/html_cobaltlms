...
// $PAGE->requires->css('/local/users/css/jquery-ui.css', true);

$PAGE->requires->jquery();
$PAGE->requires->js('/blocks/todays_timetable/js/jqueryy1.js', true);
$PAGE->requires->js('/blocks/todays_timetable/js/jquery10.js');
$PAGE->requires->js('/blocks/todays_timetable/js/tabs.js');
...
$PAGE->requires->js_call_amd('local_groups/popup', 'init',array(array('contextid' => $systemcontext->id, 'selector' => '#batchuserpopup')));
