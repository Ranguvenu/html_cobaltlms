...
if(!empty($content)){
	$STD_FIELDS = array($firstlevel,'username','employee_name', 'first_name', 'middle_name', 'last_name', $secondlevel,$thirdlevel, 'address',
	                    'zone_region', 'area', 'city', 'role_designation', 'group', 'level', 'team', 'client', 'grade', 'gender','mobileno', 'email','marital_status','dob',
	                    'doj','state_name','student_status','reportingmanager_code','reportingmanager_name','reportingmanager_email','dol','dor','country','officialmail','phone','rollno');
	$PRF_FIELDS = array();
