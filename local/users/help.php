...
if (isset($CFG->allowframembedding) and ! $CFG->allowframembedding) {
    ...
    echo '<div style="float:right;"><a href="sync/hrms_async.php" class="btn btn-primary">' . get_string('back_upload', 'local_users') . '</a></div>';
}
...
if(is_siteadmin() || has_capability('local/costcenter:manage_multiorganizations',$systemcontext)){
	echo get_string('help_1', 'local_users', $string);
    echo get_string('help_2', 'local_users', $string);
}else if(!is_siteadmin() && has_capability('local/costcenter:manage_ownorganization',$systemcontext)){
	echo get_string('help_1_orghead', 'local_users', $string);
    echo get_string('help_2_orghead', 'local_users', $string);
}else if(!is_siteadmin() && has_capability('local/costcenter:manage_owndepartments',$systemcontext)){
	echo get_string('help_1_dephead', 'local_users', $string);
    echo get_string('help_2_dephead', 'local_users', $string);
}
echo $OUTPUT->footer();
