            ...
            .then(function(response) {
                ...
                if (records.length || totalCount) {
                    ...
                    if (response.nodata) {
                        ...
                        } else if (options.targetID == 'manage_employees1') {
                            name =Str.get_string('no_employees_data', 'local_costcenter');
                        ...
                        } else if (options.targetID == 'tm_locations') {
                            name =Str.get_string('no_buildings_data', 'local_location');
                        } else if (options.targetID == 'tm_rooms') {
                            name =Str.get_string('no_rooms_data', 'local_location');
                        } else if (options.targetID == 'sessions_manage_table') {
                            name =Str.get_string('no_sessions_manage_table_data', 'local_timetable');
                        } else if (options.targetID == 'timelayoutm_view') {
                            name =Str.get_string('no_timelayoutm_view_data', 'local_timetable');
                        } else if (options.targetID == 'viewcurriculum_details') {
                            name =Str.get_string('nocurriculumsavail', 'local_curriculum');
                        } else if (options.targetID == 'manage_edxcourses') {
                            name =Str.get_string('noedxcoursesavail', 'local_edxcourses');
                        } else if (options.targetID == 'manage_opencourses') {
                            name =Str.get_string('noopencoursesavail', 'local_opencourses');
                        } else if (options.targetID == 'manage_notifications') {
                            name =Str.get_string('nonotificationsavailable', 'local_notifications');
                        }
