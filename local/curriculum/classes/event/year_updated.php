...
class year_updated extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "The user with id '$username ($USER->id)' has updated the curriculum semester year with id '$this->objectid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventcurriculumsemesteryearupdated', 'local_curriculum');
    }
