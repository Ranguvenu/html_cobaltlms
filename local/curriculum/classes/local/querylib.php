...
class querylib {
    ...
    public function get_user_department_trainerslist($service = false, $costcenters = false,
        ...
        if (!empty($costcenters)) {
         ...
         if ((has_capability('local/curriculum:manageprogram', context_system::instance())) &&
            (!is_siteadmin() )&&(!has_capability('local/curriculum:manage_multiorganizations', context_system::instance()) && !has_capability('local/costcenter:manage_multiorganizations', context_system::instance()))) {
