...
$functions = array(
    ...
    'local_groups_hide_groups' => array(
        'classname'   => 'local_groups_external',
        'methodname'  => 'hide_groups',
        'classpath'   => 'local/groups/classes/external.php',
        'description' => 'hide the groups',
        'type'        => 'write',
        'ajax' => true,
    ),
    'local_groups_unhide_groups' => array(
        'classname'   => 'local_groups_external',
        'methodname'  => 'unhide_groups',
        'classpath'   => 'local/groups/classes/external.php',
        'description' => 'unhide the groups',
        'type'        => 'write',
        'ajax' => true,
    ),
    'local_groups_delete_sub_group' => array(
        'classname'   => 'local_groups_external',
        'methodname'  => 'delete_sub_groups',
        'classpath'   => 'local/groups/classes/external.php',
        'description' => 'delete the sub groups',
        'type'        => 'write',
        'ajax' => true,
    )
);
