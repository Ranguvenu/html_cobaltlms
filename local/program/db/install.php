...
function xmldb_local_program_install() {
    ...
    $notification_type_data = array(
        ...
        array('name' => 'Program Semester Completion','shortname' => 'program_semester_completion','parent_module' => $parentid,'usercreated' => '2','timecreated' => $time,'usermodified' => 2,'timemodified' => NULL, 'pluginname' => 'program'),
    ...
    $strings = array(
        ...
        array('name' => '[program_semester_completiondate]','module' => 'program','usercreated' => '2','timecreated' => $time,'usermodified' => 2,'timemodified' => NULL),
