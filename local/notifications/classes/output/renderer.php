   ...
   /*********************Email Status(Shilpa)************************/
        public function view_email_status() {
          ...
          <div class="coursebackup course_extended_menu_itemcontainer">
            ...
            $output.= "<td class='d-xs-block'><label class='mr-1 '>".get_string('organization', 'local_notifications', $labelstring->firstlevel)."</label>
              <select class='custom_noti_filter custom-select form-control-danger' id='1'>
                       <option value=''>".get_string('select_organization', 'local_notifications', $labelstring->firstlevel)."</option>";
              ...
              $output .= "<td class='d-xs-block'>
                    <label class='ml-3 mr-1 '>".get_string('status', 'local_notifications')."</label>
                     <select class='custom_noti_filter custom-select form-control-danger' id='2'>
            ...
            $output .='<table  id = "noti_list" cellpadding="30" cellspacing="10" style="width:100%;">
                <thead>
                <tr>
                <th>'.get_string('organization', 'local_notifications', $labelstring->firstlevel).'</th>
        ...
        /////Calling this function to view details of email status///////
         public function view_email_status_details($id) {
            ...
            $return .="<div class='email_deatils'><label>From : </label><b>".$sender_name."</b> <br>"; 
            if ($admissionrecords) {
                $return .= "<label>To : </label><b>".$admissionrecords->firstname.' '.$admissionrecords->lastname."</b> <br>";
            } else {
                $return .= "<label>To : </label><b>".$receiver_name."</b> <br>";
            }

             $return .="<label>Subject : </label><b>".$notidetails->subject."</b><br></div>";
             $return .="<div> ".$notidetails->emailbody."</div>";
