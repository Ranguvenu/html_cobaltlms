...
*/
define(['local_employees/jquery.dataTables', 'jquery', 'core/str', 'core/modal_factory', 'core/modal_events',
    ...
    NewPopup.prototype.init = function() {
        ...
        // $(selector).click(function(){
            $(document).on('click', '.rolesstudentpopup', function(){
            self.id = $(this).data('id');
            self.teacherid = $(this).data('teacherid');
            self.open_identifiedas = $(this).data('open_identifiedas');
 

            Str.get_string('allstudents', 'local_employees', self).then(function(title) {
                ModalFactory.create({
    ...
    NewPopup.prototype.getBody = function(formdata) {
        ...
        if(typeof this.id != 'undefined'){
            var params = {id:this.id,teacherid:this.teacherid,open_identifiedas:this.open_identifiedas, jsonformdata: JSON.stringify(formdata)};
        }else{
            var params = {};
        }

        return Fragment.loadFragment('local_employees', 'students_display', this.contextid, params);
    };
