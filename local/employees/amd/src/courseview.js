...
define(['local_employees/jquery.dataTables', 'jquery', 'core/str', 'core/modal_factory', 'core/modal_events',
    ...
    NewPopup.prototype.init = function() {
        ...
        $(document).on('click', '.courseviewpopup', function(){
    ...
    NewPopup.prototype.dataTableshow = function(){
        Str.get_strings([
            ...
            $('#popup_courseview').DataTable({
                ...
                "oLanguage": {
                "sSearch": s[1],
                "sZeroRecords": "No Courses Available"
                },
    ...
    NewPopup.prototype.getBody = function(formdata) {
        ...
        return Fragment.loadFragment('local_employees', 'courseview_display', this.contextid, params);
    };
