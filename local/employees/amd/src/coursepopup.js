...
define(['local_employees/jquery.dataTables', 'jquery', 'core/str', 'core/modal_factory', 'core/modal_events',
    ...
    NewPopup.prototype.init = function() {
        ...
        // $(selector).click(function(){
            $(document).on('click', '.rolescoursepopup', function(){
            self.id = $(this).data('id');
            self.count = $(this).data('count');
            Str.get_string('allcourses', 'local_employees', self).then(function(title) {
    ...
    NewPopup.prototype.getBody = function(formdata) {
        ...
        if(typeof this.id != 'undefined'){
            var params = {id:this.id,count:this.count, jsonformdata: JSON.stringify(formdata)};
        }else{
            var params = {};
        }
        return Fragment.loadFragment('local_employees', 'course_display', this.contextid, params);
    };
