...
require_once($CFG->libdir . '/csvlib.class.php');
	...
	$content = file_get_contents($CFG->dirroot.'/local/employees/syncs/csv/uploaduser_'.$filedate.'.csv');
	if(!empty($content)){
	$STD_FIELDS = array('organization','username','employee_id','employee_name', 'first_name', 'middle_name', 'last_name', 'department','sub_department', 'address',
	                    ...
	                    'doj','state_name','employee_status','reportingmanager_code','reportingmanager_name','reportingmanager_email','dol','dor','country','officialmail','phone','department','subdepartment');
	...
	echo get_string('file_notfound_msg','local_employees');
	}
	echo $OUTPUT->footer();
