...
require_login();
$PAGE->set_url(new moodle_url('/local/admissions/student_preview.php'));
...
$PAGE->navbar->add(get_string('view', 'local_admissions'), new moodle_url('/local/admissions/studentview.php'));
...
echo $OUTPUT->header();
    if(!is_siteadmin()) {
        echo $OUTPUT->render_from_template('local_admissions/student_preview' , $templatecontext);
    } else {
