 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class status_revise extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        return get_string('reviseinfo', 'local_admissions', $stringHelpers);
    }
    ...
    public static function get_name() {
        return get_string('user_requested_for_revision', 'local_admissions');
    }
