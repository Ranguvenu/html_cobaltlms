 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class status_reject extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        return get_string('rejectinfo', 'local_admissions', $stringHelpers);
    }
    ...
    public static function get_name() {
        return get_string('eventadmission_user_rejected', 'local_admissions');
    }
