 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class status_create extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        ...
        $stringHelpers->other = $this->other['programid, email, registrationid'];
        return get_string('createinfo', 'local_admissions', $stringHelpers);
    }
    ...
    public static function get_name() {
        return get_string('eventadmission_users_created', 'local_admissions');
    }
