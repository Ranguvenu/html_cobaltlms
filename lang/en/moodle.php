...
$string['categorycurrentcontents'] = 'Do you really want to delete <b>{$a}</b>?';
...
$string['sitenews'] = '<h2> Notice Board </h2>';
...
$string['cr_description_help'] = 'Description about the curriculum';

$string['Welcome_back'] = 'Welcome back, ';
$string['Welcome_back_hi'] = '! 👋';
