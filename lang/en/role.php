...
$string['confirmroleprevent'] = 'Do you really want to remove the <strong>{$a->role}</strong>  role for the capability <b>{$a->cap}</b>?';
...
$string['roleallowinfo'] = 'Select a role to add to the list of allowed roles for the capability "{$a->cap}"';
...
$string['roleprohibitinfo'] = 'Select a role to add to the list of prohibited roles for the capability "{$a->cap}"';
