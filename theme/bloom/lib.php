...
function theme_bloom_css_tree_post_processor($tree, $theme) {
    error_log('theme_bloom_css_tree_post_processor() is deprecated. Required' .
        'prefixes for Bootstrap are now in theme/bloom/scss/moodle/prefixes.scss');
...
function theme_bloom_get_extra_scss($theme) {
    ...
    if (!empty($loginbackgroundimageurl)) {
        $content .= 'body#page-login-index #page-wrapper #page { ';
        $content .= "background-image: url('$loginbackgroundimageurl')!important; background-size: cover;";
        $content .= ' }';
    }else{
        $content .= 'body#page-login-index #page-wrapper #page { ';
        $content .= "background-image: url([[pix:theme_bloom|loginbackground]]) !important;";
        $content .= ' }';
    }
 ...
 */
function theme_bloom_get_precompiled_css() {
    global $CFG;
    return file_get_contents($CFG->dirroot . '/theme/bloom/style/moodle.css');
}
