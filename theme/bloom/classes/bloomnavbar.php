...
/**
 * Creates a navbar for bloom that allows easy control of the navbar items.
 *
 * @package    theme_bloom
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bloomnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_bloom();
    }

    /**
     * Prepares the navigation nodes for use with bloom.
     */
    protected function prepare_nodes_for_bloom(): void {
        global $PAGE;
    ...
    /**
     * Get all the bloomnavbaritem elements.
     *
     * @return bloomnavbaritem[] bloom navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this bloom navbar
     */
    ...
    /**
     * Remove a bloomnavbaritem from the bloom navbar.
     *
     * @param  string|int $itemkey An identifier for the bloomnavbaritem
     * @param  int|null $itemtype An additional type identifier for the bloomnavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the bloomnavbaritem.
     */
