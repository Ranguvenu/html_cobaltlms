...
use theme_bloom\privacy\provider;

/**
 * Unit tests for theme_bloom/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_bloom');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_bloom'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_bloom'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
