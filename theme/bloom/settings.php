...
if ($ADMIN->fulltree) {
    ...
    $setting = new admin_setting_configtext('theme_bloom/unaddableblocks',
        get_string('unaddableblocks', 'theme_bloom'), get_string('unaddableblocks_desc', 'theme_bloom'), $default, PARAM_TEXT);
    $page->add($setting);
    ...
    $fs = get_file_storage();
    $files = $fs->get_area_files($context->id, 'theme_bloom', 'preset', 0, 'itemid, filepath, filename', false);
    ...
    $setting = new admin_setting_configthemepreset($name, $title, $description, $default, $choices, 'bloom');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Preset files setting.
    $name = 'theme_bloom/presetfiles';
    $title = get_string('presetfiles','theme_bloom');
    $description = get_string('presetfiles_desc', 'theme_bloom');
    ...
    $name = 'theme_bloom/loginbackgroundimage';
    $title = get_string('loginbackgroundimage', 'theme_bloom');
    $description = get_string('loginbackgroundimage_desc', 'theme_bloom');
