...
* remove folder theme/bloom/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/bloom/scss/bootstrap
...
* comment out this line in theme/bloom/scss/_print.scss
    @page {
...
* remove folder theme/bloom/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/bloom/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/bloom/amd/src
* edit theme/bloom/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/bloom run "grunt amd" to compile the bootstrap JS
* in folder theme/bloom run "grunt css" to compile scss
