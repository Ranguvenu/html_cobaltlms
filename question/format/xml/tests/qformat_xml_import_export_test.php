...
class qformat_xml_import_export_test extends advanced_testcase {
    ...
    public function test_import_nested_categories() {
        ...
        $this->assert_category_imported('bloom', 'This is bloom category for test', FORMAT_MARKDOWN);
        $this->assert_category_imported('Zeta', 'This is Zeta category for test', FORMAT_MOODLE);
        $this->assert_category_has_parent('Delta', 'top');
        $this->assert_category_has_parent('bloom', 'Delta');
        $this->assert_category_has_parent('Zeta', 'bloom');
    }
    ...
    public function test_export_nested_categories() {
        ...
        $categorydelta = $generator->create_question_category([
                ...
                'parent' => '0',
                'sortorder' => '999']);
        $categorybloom = $generator->create_question_category([
                'name' => 'bloom',
                'contextid' => '2',
                'info' => 'This is bloom category for test',
                'infoformat' => '4',
                'stamp' => make_unique_id_code(),
        ...
        $qformat->setCategory($categorybloom);
