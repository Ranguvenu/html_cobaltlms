...
$string['deletetemplateconfirm'] = 'Do you really want to delete <b>{$a}</b>, which you cannot revert if removed?';
...
$string['demotmplforcompleting'] = 'For completing the program';
...
$string['duplicatetemplateconfirm'] = 'Are you sure you want to duplicate <b>{$a}</b>?';
